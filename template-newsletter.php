...
add_filter( 'body_class', function( $classes ) {
    return array_merge( $classes, [ 'no-gradient' ] );
} );
...
<main>
    ...
    <form action="<?php echo manipulate_get_params(['subscribe_newsletter' => '']); ?>" method="post">
        ...
        <div class="row">
            <input class="btn btn-primary btn-full" type="submit" value="Anmelden">
        </div>
    </form>
    <p class="text-grey text-xs mt-3 text-justify mb-0">Für den Versand unserer Newsletter nutzen wir rapidmail. Mit deiner Anmeldung stimmst du zu, dass die eingegebenen Daten an rapidmail übermittelt werden. Beachte bitte deren <a href="https://www.rapidmail.de/agb" target="_blank" rel="noreferrer noopener">AGB</a> und <a href="https://www.rapidmail.de/datenschutz-kundenbereich" target="_blank" rel="noreferrer noopener">Datenschutzbestimmungen</a>.</p>
    <?php else: ?>
